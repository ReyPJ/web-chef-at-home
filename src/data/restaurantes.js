export const restaurantes = [
    {
        ...
        menu: {
            ...
            'Bebidas': [
                {name: 'Coca Cola', description: 'Refresco', price: 60},
                {name: 'Mineral', description: 'Agua mineral', price: 60},
                {name: 'Coca Cero', description: 'Refresco sin azúcar', price: 60},
                {name: 'Coca Light', description: 'Refresco light', price: 60},
                {name: 'Mundet', description: 'Refresco', price: 60},
                {name: 'Sprite', description: 'Refresco', price: 60},
