export const restaurantes = [
  {
    ...
    description: '¿Qué es la cocina mexicana?, ¿son esos frijoles con epazote y chicharrón?, ¿son esas memelas?, ¿fue cuando aprendí a comer tacos de sal de tortilla recién hecha?, ¿fue ese café con piloncillo? ¿O ese mole de guajolote que todos recordamos?... el arte de transformar ingredientes está por descubrirse…',
    menu: {
      'Desayunos': [
        {
          name: 'Huevos Fritos',
          description: 'Tiernos, Bien cocidos, Volteados / con frijoles de la olla y arroz blanco',
          price: 175
        },
        {
          name: 'Huevos Divorciados',
          description: 'Sobre tortillas pocheadas, salsas verde y ranchera / con frijoles de la olla y arroz blanco',
          price: 180
        },
        {
          name: 'Huevos Pasilla',
          description: '3 piezas de huevo orgánico, revueltos y bañados con salsa de chile pasilla / con frijoles de la olla y arroz blanco',
          price: 180
        },
        {
          name: 'Huevos Rancheros',
          description: 'Tiernos ó bien cocidos, sobre tortillas pocheadas, frijol y jamón al grill / arroz blanco',
          price: 180
        },
        {
          name: 'Huevos Machaca',
          description: 'Machaca y huevos revueltos, bañados con salsa ranchera / con frijoles de olla y arroz blanco',
          price: 180
        },
        {
          name: 'Huevos revueltos con jamón de York',
          description: 'Huevos orgánico revueltos, jamón de York / con frijoles de olla y arroz blanco',
          price: 180
        },
        {
          name: 'Huevos revueltos con Jamón de pavo',
          description: 'Huevos orgánico revueltos, tocino ahumado Hormel / con frijoles de olla y arroz blanco',
          price: 180
        },
        {
          name: 'Plato de fruta de temporada',
          description: 'Rebanadas de fruta de temporada, con o sin yogurt griego, granola y miel',
          price: 175
        },
        {
          name: 'Bowl de frutos rojos',
          description: 'Fresa, zarzamora, blueberries, yogurt griego, granola, miel',
          price: 190
        },
        {
          name: 'Bagel Salmón',
          description: 'Salmón ahumado, queso doble crema, cebolla morada, aceitunas negras, alcaparras, limón',
          price: 220
        },
        {
          name: 'Avocado Toast',
          description: 'Hogaza de masa madre hecha en casa, mezcla de hojas, jitomate Cherry, pepita verde, aguacate en láminas, limón Eureka',
          price: 185
        },
      ],
      "Adicionales": [
        {
          name: 'Extra cottage (60gr)',
          description: '',
          price: 50
        },
        {
          name: 'Pechuga pollo orgánico (100 gr)',
          description: '',
          price: 65
        },
        {
          name: 'Salmón ahumado (90 gr)',
          description: '',
          price: 65
        },
        {
        ...
        {
          name: 'Chicharrón prensado (110 gr)',
          description: '',
          price: 50
        },
        {
          name: 'Huevo orgánico (2 pza)',
          description: '',
          price: 40
        },
      ],
      ...
      'Refrescos': [
        ...
        { name: 'Mineral', description: 'Agua mineral', price: 45 },
        { name: 'Coca Cero', description: 'Refresco sin azúcar', price: 45 },
        { name: 'Coca Light', description: 'Refresco light', price: 45 },
        { name: 'Mundet', description: 'Refresco', price: 45 },
        { name: 'Sprite', description: 'Refresco', price: 45 },
      ],
      'Jugos Cold Press': [
        { name: 'Cold Press Naranja', description: 'Jugo prensado en frío', price: 55 },
        { name: 'Cold Press Toronja', description: 'Jugo prensado en frío', price: 55 },
        { name: 'Cold Press Verde', description: 'Pepino, jengibre, nopal, espinaca, piña y apio', price: 65 },
      ...
      'Atoles (8 AM a 1 PM)': [
        ...
        { name: 'Atole de Coco', description: '', price: 55 },
      ]
    },
    deliveryLinks: {
      uberEats: "//uber",
  ...
  },
  {
    id: 'papa-world',
    name: 'Papa World',
    tagLine: 'Papas al nivel de la alta cocina',
    description: 'Nuestras papas horneadas tienen una cocción suave y lenta pasando por un proceso de gelanitización que vuelve el relleno tierno y delicioso, añadimos crème fraîche, cebollín y un toque de mantequilla, con el relleno que prefieras, gratinadas en horno de piedra, completamos esta filosofía con platillos hechos en casa desde cero, utilizando ingredientes frescos, locales y sin ultra procesados',
    menu: {
      'Papas horneadas': [
        {
          name: 'Clásica',
  ...
  },
  {
    ...
    tagLine: 'Una panaderia de alta cocina',
    description: 'Un pan, un rol de canela glaseado, un Cinnabon puede evocar los sentidos y asociando sus procesos y productos con amor y el afecto, el aire, el reposo, la consistencia del glaseado, cada detalle cuenta, nuestros Cinnabons no solo son un manjar, es un viaje al pasado, a la casa de la abuela en Mauripol, a tardes de risas y a la simple felicidad de un suave bocado, con la receta de nuestra chef pastelera Valya les traemos deliciosos Cinnabons y una extraordinaria selección de pan artesanal',
    menu: {
      'Cinnabons': [
        {
          name: '2 Piezas 90gr',
          description: 'Glaseado, fermentado lentamente, con canela y recomendablemente suave',
          price: 125
        },
        {
          name: 'Paquete (6 piezas)',
          description: 'Glaseado, fermentado lentamente, con canela y recomendablemente suave',
          price: 320
        },
      ],
      ...
      "Jugos Cold Press (8 AM a 1 PM)": [
        { name: 'Naranja', description: '', price: 50 },
        { name: 'Toronja', description: '', price: 50 },
        { name: 'Verde', description: 'Pepino, jengibre, nopal, espinaca, piña y apio', price: 55 },
