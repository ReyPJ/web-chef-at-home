    ...
    return (
        <section className="relative py-12 md:py-16 px-4 bg-black border-y border-gold/30">
            <div className="max-w-3xl mx-auto text-center">
                ...
                {/* Subtítulo */}
                <p className="font-playfair text-white/80 text-sm md:text-base uppercase tracking-[0.25em] mb-8">
                    Próximamente
                </p>
                ...
                {/* Mensaje adicional */}
                <p className="font-playfair text-gold/70 text-xs italic uppercase tracking-[0.2em]">
