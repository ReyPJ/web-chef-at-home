            ...
            <div className="relative z-10 max-w-6xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between mb-12 pb-8 border-b border-gold/30">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <p className="text-gold font-playfair text-base md:text-lg italic tracking-wide">
                            Encuéntralo en
                        </p>
                ...
                <div className="text-center mb-10 space-y-3">
                    <h3 className="text-white font-playfair text-2xl md:text-3xl italic uppercase tracking-widest">
                        {menuCategories[activeMenuCategory]} <span className="text-gold">--</span> 8am a 1pm
                    </h3>
                    <p className="text-gold/90 font-playfair text-sm italic uppercase tracking-[0.3em]">
                ...
                <div className="flex gap-3 overflow-x-auto pb-4 md:justify-center scrollbar-hide">
                    {menuCategories.map((category, index) => (
                        <button
                            ...
                            className={`px-6 md:px-10 py-3 font-playfair uppercase tracking-[0.2em] text-xs md:text-sm whitespace-nowrap transition-all duration-300 border-2 ${
                ...
                <div className="mt-16 text-center pt-8 border-t border-gold/20">
                    <p className="text-gold/60 font-playfair text-xs italic uppercase tracking-[0.25em] leading-relaxed max-w-3xl mx-auto">
